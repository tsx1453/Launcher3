...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (getChildCount() <= 0) {
//            Log.d("mylauncher3", "ViewGroup.onInterceptTouchEvent()");
...
//            Log.d("mylauncher3", "move && scrolling");
            return true;
        }
...
//                    Log.d("mylauncher3", "determinScrollingStart");
...
//                        Log.d("mylauncher3", "setCurrentPage:" + getNextPage());
                        setCurrentPage(getNextPage());
                        pageEndTransition();
                    }
                } else {
                    if (isTouchPointInViewportWithBuffer((int) mDownMotionX, (int) mDownMotionY)) {
//                        Log.d("mylauncher3", "TOUCH_STATE_SCROLLING");
                        mTouchState = TOUCH_STATE_SCROLLING;
                    } else {
//                        Log.d("mylauncher3", "TOUCH_STATE_REST");
                        mTouchState = TOUCH_STATE_REST;
                    }
                }
...
//                Log.d("mylauncher3", "resetTouchState");
                resetTouchState();
                break;

            case MotionEvent.ACTION_POINTER_UP:
//                Log.d("mylauncher3", "onSecondarypointerup");
         ...
         * drag mode.
         */
//        Log.d("mylauncher3", "return " + (mTouchState != TOUCH_STATE_REST));
